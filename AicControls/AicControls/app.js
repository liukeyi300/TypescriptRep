        ...
        (function (Controls) {
            var Greeter = (function () {
                ...
                Greeter.prototype.start = function () {
                    ...
                    //    i++;
                    //});
                    var pipe = new Controls.Pipe($('svg')[0], { x: 0, y: 0 });
                    var pipe = new Controls.Pipe($('svg')[0], { x: 100, y: 100, status: [{ statuContent: "abc", statuColor: "#FF0000" }, { statuContent: "def", statuColor: "#0000FF" }] });
                };
