...
module AicTech.Web.Html {
    export class AccomplishRateByOffer extends Module.ModuleBase {
        private allARData;
        private allPo = [];
        ...
        constructor() {
            ...
            $.extend(this.viewModel, kendo.observable({
                ...
                advanceData: function (e) {
                    (<AccomplishRateByOffer>Module.ModuleLoad.getModuleInstance('AccomplishRateByOffer')).redrawChart(RedrawStatu.Advance);
                },
                backoffData: function (e) {
                    (<AccomplishRateByOffer>Module.ModuleLoad.getModuleInstance('AccomplishRateByOffer')).redrawChart(RedrawStatu.Backoff);
                }
            }));
        }
        ...
        private getAllData(start: Date, end: Date, equId: string, callback: Function) {
            var instance = <AccomplishRateByOffer>Module.ModuleLoad.getModuleInstance("AccomplishRateByOffer"),
                currentData: OfferAccmplshRtDataModel;
            instance.serviceContext.V_PPA_MAT_RECORD_PLAN
                ...
                .toArray((re) => {
                    ...
                    re.forEach((it) => {
                        currentData = new OfferAccmplshRtDataModel(it);
        ...
        refreshData() {
            ...
            try {
                (function (instance: AccomplishRateByOffer) {
