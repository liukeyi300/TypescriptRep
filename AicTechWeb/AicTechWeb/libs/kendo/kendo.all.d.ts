...
declare module kendo.dataviz.ui {
    ...
    interface ChartOptions {
        ...
        transitions?: boolean;
        valueAxis?: any;//ChartValueAxisItem;  
...
declare module kendo.data {
    class PivotDataSource extends Observable {
        constructor(options?: PivotDataSourceOptions);
        options: PivotDataSourceOptions;
        axes(): any;
        catalog(): string;
    ...
    interface PivotDataSourceColumn {
        expand?: boolean;
        name?: string;
    }

    interface PivotDataSourceMeasure {
        values?: any;
        axis?: string;
    }

    interface PivotDataSourceRow {
        expand?: boolean;
        name?: string;
    }

    interface PivotDataSourceSchema {
        axes?: any;
        catalogs?: any;
        cubes?: any;
        data?: any;
    ...
    interface PivotDataSourceTransportConnection {
        catalog?: string;
        cube?: string;
    }

    interface PivotDataSourceTransport {
        discover?: any;
        connection?: PivotDataSourceTransportConnection;
    }

    interface PivotDataSourceOptions {
        name?: string;
        columns?: PivotDataSourceColumn[];
        measures?: PivotDataSourceMeasure[];
        rows?: PivotDataSourceRow[];
        transport?: PivotDataSourceTransport;
        schema?: PivotDataSourceSchema;
    }

    interface PivotDataSourceEvent {
        sender: PivotDataSource;
        isDefaultPrevented(): boolean;
        preventDefault: Function;
    }
