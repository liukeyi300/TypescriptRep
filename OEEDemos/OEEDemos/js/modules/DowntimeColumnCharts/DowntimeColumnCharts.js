...
(function (OEEDemos) {
    var DowntimeColumnCharts = (function () {
        ...
        DowntimeColumnCharts.prototype.refreshData = function () {
            var startTime, endTime, dtInstance = OEEDemos.ModuleLoad.getModuleInstance("DowntimeColumnCharts"), equId = dtInstance.currentNode, day = new Date();
        ...
        DowntimeColumnCharts.prototype.init = function (view) {
            ...
            this.currentNode = OEEDemos.StartUp.Instance.currentEquipmentId;
